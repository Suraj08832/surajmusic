...
❖ ϻᴧᴅє ʙʏ ➠ 🍹𝆺𝅥⃝🤍  ●𝁂꯭𝗭𝗲‌𝗳𝗿𝗼‌𝗻 ‌🔥🍁 ̶꯭𝅥ͦ𝆬 𝄄𝄀꯭𝄄꯭⎯꯭ͯ⟶⋆𝄄𝄀꯭𝄄꯭⎯꯭ͯ⟶⋆[@crush_hu_tera](https://t.me/crush_hu_tera) **
"""
...
HELP_8 = """```
❖ ʟσσᴩ sᴛʀєᴧϻ ❖```
**sᴛᴧʀᴛs sᴛʀєᴧϻɪηɢ ᴛʜє σηɢσɪηɢ sᴛʀєᴧϻ ɪη ʟσσᴩ

❍ /loop [enable/disable] : єηᴧʙʟєs/ᴅɪsᴧʙʟєs ʟσσᴩ ғσʀ ᴛʜє σηɢσɪηɢ sᴛʀєᴧϻ
❍ /loop [1, 2, 3, ...] : єηᴧʙʟєs ᴛʜє ʟσσᴩ ғσʀ ᴛʜє ɢɪᴠєη ᴠᴧʟυє
...
❍ /speed or /playback : ғσʀ ᴧᴅᴊυsᴛɪηɢ ᴛʜє ᴧυᴅɪσ ᴘʟᴧʏʙᴧᴄᴋ sᴘєєᴅ ɪη ɢʀσυᴩ
