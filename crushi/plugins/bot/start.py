...
from crushi.misc import _boot_
from crushi.plugins.sudo.sudoers import sudoers_list
from crushi.utils.database import get_served_chats, get_served_users, get_sudoers
from crushi.utils import bot_sys_stats
from crushi.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_lang,
...
from crushi.utils.decorators.language import LanguageStart
from crushi.utils.formatters import get_readable_time
from crushi.utils.inline import help_pannel, private_panel, start_panel
...
NEXI_VID = [
"https://files.catbox.moe/m5g5kj.mp4",
]
